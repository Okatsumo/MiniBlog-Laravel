                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="btn" title="подчеркнуть">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-type-underline" viewBox="0 0 16 16">
                                    <path d="M5.313 3.136h-1.23V9.54c0 2.105 1.47 3.623 3.917 3.623s3.917-1.518 3.917-3.623V3.136h-1.23v6.323c0 1.49-.978 2.57-2.687 2.57-1.709 0-2.687-1.08-2.687-2.57V3.136zM12.5 15h-9v-1h9v1z"/>
                                </svg>
                            </span>

                            <span class="btn" title="зачеркнуть">
                            ...
                            <span class="btn" title="обычный текст">
                            ...
                            <span class="btn" title="расположить слева">
                            ...
                            <span class="btn" title="центрировать">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-text-center" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M4 12.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
                                </svg>
                            </span>

                            <span class="btn" title="расположить справа">
                            ...
                            <span class="btn" title="загрузить изображение">
                            ...
                            <span class="btn" title="загрузить файл">
                    ...
                    <textarea  contenteditable="true" class="form-control" id="contentInput" rows="16" ></textarea>
                </div>
